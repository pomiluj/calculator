...
!function (t, n) {
    'object' == typeof exports && 'object' == typeof module ? module.exports = n() : 'function' == typeof define && define.amd ? define('flight', [], n) : 'object' == typeof exports ? exports.flight = n() : t.flight = n();
}(this, function () {
    return function (t) {
        function n(o) {
            if (e[o])
        ...
        function (t, n, e) {
            ...
            o = [
                ...
                function c(t) {
                    for (var e = arguments.length, o = new Array(e - 1), r = 1; e > r; r++)
                        o[r - 1] = arguments[r];
                    if (!t)
                ...
                function f() {
                    for (var l = arguments.length, h = new Array(l), p = 0; l > p; p++)
                        h[p] = arguments[p];
                    var d = function () {
                    };
            ...
            o = [e(7)], i = function (t) {
                ...
                function e(t, e) {
                    ...
                    for (var o = 0; o < e.length; o++)
                        -1 == t.mixedIn.indexOf(e[o]) && (n(t, !1), e[o].call(t), t.mixedIn.push(e[o]));
                    n(t, !0);
                }
                var o = [
                    'mixedIn',
                ...
                function n(t, e, o) {
                    ...
                    a.forEach(function (o) {
                        (g[t] || t)(e, i, o) && console.log([
                            ...
                            typeof i[o],
                            ')'
                        ].join(''), i[o]), '[object Object]' == Object.prototype.toString.call(i[o]) && i[o] != i && -1 == r.split('.').indexOf(o) && n(t, e, {
                            obj: i[o],
                            path: [
                                r,
                                o
            ...
            o = [e(7)], i = function (t) {
                ...
                function e(t, e, o) {
                    if (window.DEBUG && window.DEBUG.enabled) {
                        ...
                        'function' == typeof o[o.length - 1] && (c = o.pop(), c = c.unbound || c), 1 == o.length ? (s = e.$node[0], a = o[0]) : 2 != o.length || 'object' != typeof o[1] || o[1].type ? (s = o[0], a = o[1], 'trigger' == t && (u = o[2])) : (s = e.$node[0], a = o[0], 'trigger' == t && (u = o[1])), r = 'object' == typeof a ? a.type : a, f = DEBUG.events.logFilter, h = 'all' == f.actions || f.actions.indexOf(t) > -1, l = function (t) {
                            ...
                            t,
                            '[' + r + ']'
                        ], u && d.push(u), d.push(n(s)), d.push(e.constructor.describe.split(' ').slice(0, 3).join(' ')), console.groupCollapsed && 'trigger' == t && console.groupCollapsed(t, r), Function.prototype.apply.call(console.info, console, d));
                    }
                }
                function o() {
                ...
                function e() {
                    ...
                    function o(t) {
                        this.instance = t, this.events = [], this.addBind = function (t) {
                            ...
                            for (var e, o = 0; e = this.events[o]; o++)
                                n(e, t) && this.events.splice(o, 1);
                        };
                    }
                    var i = this;
                    (this.reset = function () {
                        ...
                        for (var n, e = t.attachTo ? t : t.constructor, o = 0; n = this.components[o]; o++)
                            if (n.component === e)
                                return n;
                        return null;
                        ...
                        for (var e, o = i.findInstanceInfo(this), r = arguments.length, a = 1, s = new Array(r - 1); r > a; a++)
                            s[a - 1] = arguments[a];
                        if (o) {
                        ...
                        o && o.removeBind(e);
                        for (var r, a = 0; r = i.events[a]; a++)
                            n(r, e) && i.events.splice(a, 1);
                    }, i.trigger = function () {
            ...
            o = [e(4)], i = function (t) {
                ...
                var e = 100, o = {
                        ...
                        toArray: function (t, n) {
                            n = n || 0;
                            for (var e = t.length, o = new Array(e - n), i = n; e > i; i++)
                                o[i - n] = t[i];
                            return o;
                        },
                        merge: function () {
                        ...
                        push: function (t, n, e) {
                            return t && Object.keys(n || {}).forEach(function (o) {
                                if (t[o] && e)
                                    throw new Error('utils.push attempted to overwrite "' + o + '" while running in protected mode');
                        ...
                        compose: function () {
                            var t = arguments;
                            return function () {
                                for (var n = arguments, e = t.length - 1; e >= 0; e--)
                                    n = [t[e].apply(this, n)];
                                return n[0];
                            };
                        },
                        uniqueArray: function (t) {
                            for (var n = {}, e = [], o = 0, i = t.length; i > o; ++o)
                                n.hasOwnProperty(t[o]) || (e.push(t[o]), n[t[o]] = 1);
                            return e;
                        },
                        ...
                        delegate: function (t) {
                            return function (n, e) {
                                ...
                                Object.keys(t).forEach(function (r) {
                                    return !n.isPropagationStopped() && (o = i.closest(r)).length ? (e = e || {}, n.currentTarget = e.el = o[0], t[r].apply(this, [
                                        n,
                                        e
                                    ])) : void 0;
                                }, this);
            ...
            o = [
                ...
                function i(t, n) {
                    try {
                        ...
                        throw console.log('unserializable data for event', t, ':', n), new Error([
                            'The event',
                            t,
                            'on component',
                            this.toString(),
                ...
                function r(t) {
                    ...
                    if (this.attr = new this.attrDef(), e.enabled && window.console) {
                        ...
                        for (var r = n.length - 1; r >= 0; r--)
                            if (-1 == o.indexOf(n[r])) {
                                console.warn('Passed unused attributes including "' + n[r] + '" to component "' + this.toString() + '".');
                                break;
                            }
                    }
                    for (var i in this.attrDef.prototype) {
                        if ('undefined' == typeof t[i]) {
                            if (null === this.attr[i])
                                throw new Error('Required attribute "' + i + '" not specified in attachTo for component "' + this.toString() + '".');
                        } else
                            this.attr[i] = t[i];
                ...
                function a(t) {
                    ...
                    for (var e in this.defaults)
                        t.hasOwnProperty(e) || (n[e] = this.defaults[e]);
                ...
                function c() {
                    this.trigger = function () {
                        ...
                        if (i = 'object' == typeof a ? t.delegate(this.resolveDelegateRules(a)) : 'string' == typeof a ? s(a) : a, 2 == r ? (n = $(arguments[0]), e = arguments[1]) : (n = this.$node, e = arguments[0]), 'function' != typeof i && 'object' != typeof i)
                            throw new Error('Unable to bind to "' + e + '" because the given callback is not a function or an object');
                        ...
                        if ('function' == typeof arguments[i] && (o = arguments[i], i -= 1), 1 == i ? (t = $(arguments[0]), e = arguments[1]) : (t = this.$node, e = arguments[0]), o) {
                            ...
                            n.findInstanceInfo(this).events.forEach(function (n) {
                        ...
                        return Object.keys(t).forEach(function (e) {
                            if (!(e in this.attr))
                                throw new Error('Component "' + this.toString() + '" wants to listen on "' + e + '" but no such attribute was defined.');
                            n[this.attr[e]] = 'string' == typeof t[e] ? s(t[e]) : t[e];
                        }, this), n;
                        ...
                        if (n = n || {}, this.identity || (this.identity = u++), !t)
                            throw new Error('Component needs a node');
                        return t.jquery ? (this.node = t[0], this.$node = t) : (this.node = t, this.$node = $(t)), this.attrDef ? r.call(this, n) : a.call(this, n), this;
                    }, this.teardown = function () {
...
define('input', [
    ...
    var input = flight.component(function () {
        ...
        this.addNumberToBox = function (e, d) {
            var number = $(e.target).val();
            this.trigger(document, 'addNumbers', { number: number });
        };
...
define('output', [
    ...
    var input = flight.component(function () {
        ...
        this.equals = function (e, d) {
            ...
            var bufferAtCapacity = currentBuffer.match(/\|/i) !== null;
        ...
        this.addBumbers = function (e, d) {
            var currentOutput = $(this.attr.theBox).val();
            var currentBuffer = $(this.attr.buffer).val();
            var bufferAtCapacity = currentBuffer.match(/\|/i) !== null;
            if ($(this.attr.last).val() === 'operator')
                $(this.attr.theBox).val(d.number);
            else
                $(this.attr.theBox).val(currentOutput + '' + d.number);
